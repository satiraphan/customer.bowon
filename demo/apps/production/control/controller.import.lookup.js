				...
				for(i in json){
					s += '<tr class="new">';
						s += '<td class="text-center">';
							s += '<span class="btn btn-danger btn-xs" onclick="$(this).parent().parent().remove()"><i class="fa fa-trash"></i></span>';
						...
						s += '</td>';
						s += '<td>';
							s += '<input type="time" name="import_time[]" class="form-control form-control-sm" placeholder="ต้องระบุข้อมูล">';
						s += '</td>';
						s += '<td>';
							s += '<input name="import_delivery_note[]" class="form-control form-control-sm" placeholder="ต้องระบุข้อมูล">';
						s += '</td>';
						s += '<td>';
