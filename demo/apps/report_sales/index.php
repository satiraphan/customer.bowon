				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<select name="type" class="form-control">
							<option value="view.sales">รานงานการขาย</option>
							<option value="view.delivery">รายงานการส่งของ</option>
							<option value="view.กaily_sales">รายงานการซื้อ-ขายประจำวัน</option>
						</select>
					</div>
					<div class="col-sm-2">
