...
$("#tblSpot").DataTable({
	...
	"aoColumns": [
		...
		{"bSortable":false	,"data":"amount"	,"class" : "text-center"},
		{"bSortable":false	,"data":"amount"	,"class" : "text-center"},
		{"bSortable":false	,"data":"rate_spot"	,"class" : "text-center"},
		{"bSortable":false	,"data":"rate_pmdc"	,"class" : "text-center"},
	...
	"createdRow": function ( row, data, index ) {
		...
		s = '';
		s += '<input class="form-control form-control-sm" name="spot[]" data-name="spot" value="' + parseFloat(data.amount.replace(/,/g, '')) + '">';
		s += '';
		s += '';
		$("td", row).eq(5).html(s);
