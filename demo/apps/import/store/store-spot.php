<?php
	...
	$columns = array(
		...
		"amount" 		=> "FORMAT(bs_purchase_spot.amount,2)",
		"rate_spot" 	=> "FORMAT(bs_purchase_spot.rate_spot,2)",
		"rate_pmdc" 	=> "FORMAT(bs_purchase_spot.rate_pmdc,2)",
	...
	$table = array(
		...
		),"where" => "bs_purchase_spot.status = 1"
	);
	
	if(isset($_GET['where'])){
		$table['where'] .= " AND ".$_GET['where'];
	}
