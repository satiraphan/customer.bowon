...
$('#tblDatabase').DataTable({
	...
	"processing": true,
	"serverSide": true,
	"ajax": "apps/database/store/company/store-currency.php",
	"aoColumns": [
	...
	"createdRow": function ( row, data, index ) {
		...
		s += fn.ui.button("btn btn-xs btn-outline-dark","far fa-pen","fn.app.database.company.currency.dialog_edit("+data[0]+")");
		$('td', row).eq(4).html(s);
	}
});
