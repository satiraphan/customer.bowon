	...
	<?php
		switch($panel->getView()){
			case "delivery":
				...
				if($os->allow("delivery","prepare"))include "control/controller.delivery.prepare.js";
				if($os->allow("delivery","delivery"))include "control/controller.delivery.delivery.js";
