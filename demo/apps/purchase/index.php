	...
	<?php
		switch($panel->getView()){
			case "spot":
				...
				if($os->allow("purchase","remove"))include "control/controller.spot.remove.js";
				if($os->allow("purchase","split"))include "control/controller.spot.split.js";
				if($os->allow("purchase","combine"))include "control/controller.spot.combine.js";
				break;
			case "usd":
