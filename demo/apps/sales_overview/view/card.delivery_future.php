<table class="datatable table table-striped table-sm table-bordered dt-responsive nowrap">
	...
	<?php
		...
		while($order = $dbc->Fetch($rst)){
			echo '<tr>';
				...
				echo '<td class="text-right">'.number_format($order['amount'],2).'</td>';
	...
	<thead>
		<tr>
			...
			<th class="text-center"><?php echo number_format($total_total,4);?></th>

			<th class="text-center"><?php echo number_format($total_net,4);?></th>
