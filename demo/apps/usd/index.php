	...
	<?php
		switch($panel->getView()){
			case "purchase":
				...
				if($os->allow("spot_silver","add"))include "../purchase/control/controller.usd.add.js";
				if($os->allow("spot_silver","edit"))include "../purchase/control/controller.usd.edit.js";
